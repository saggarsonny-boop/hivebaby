...
for (const file of files) {
  ...
  // Need to use regex to find my previous broken insertion
  const oldStr = /\{\" \\\\u00B7 \"\}\n\s*<a href=\"https:\/\/converter\.hive\.baby\"[^>]*>\n\s*<img src=\"\/ud-logo-micro\.png\"[^>]*\/>\n\s*Try UD Converter [^<]*\n\s*<\/a>/g;
...
console.log('Processed ' + files.length + ' HiveFooter.tsx files to fix encoding.');
