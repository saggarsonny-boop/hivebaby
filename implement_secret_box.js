...
fs.writeFileSync(path.join(__dirname, 'apps/hive-secretbox/app/page.tsx'), pageContent.trim(), 'utf8');

// Also fix layout
let layout = fs.readFileSync(path.join(__dirname, 'apps/hive-secretbox/app/layout.tsx'), 'utf8');
layout = layout.replace(/HivePlainscan/g, 'Secret Box');
layout = layout.replace(/Advanced MRI and Medical Scan Translation/g, 'Share a secret. Receive a secret. Feel less alone.');
fs.writeFileSync(path.join(__dirname, 'apps/hive-secretbox/app/layout.tsx'), layout, 'utf8');

console.log('Secret Box V0 UI implemented.');
