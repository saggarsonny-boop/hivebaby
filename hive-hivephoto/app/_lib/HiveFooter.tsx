// Canonical Hive footer for HivePhoto. Renders the canonical link row +
// "Made with ♥ in the Hive" signature with #D4AF37 heart and the hex
// hive mark glyph. Mirrors the aestheticbestie / imr footer with
// engine-specific gradient stop ids so multiple Hive engines can co-exist
// in a single SSR document tree without SVG defs colliding.
...
const HiveMark = ({ size = 20 }: { size?: number }) => (
  ...
  >
    <defs>
      <linearGradient id="hphoto-rim" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0%" stopColor="#FFE6A1" />
        <stop offset="40%" stopColor="#D4AF37" />
        <stop offset="100%" stopColor="#5e4a0d" />
      </linearGradient>
      <radialGradient id="hphoto-face" cx="32%" cy="28%" r="85%">
    ...
    <polygon
      ...
      fill="url(#hphoto-rim)" stroke="#8a6f1f" strokeWidth="0.6"
      strokeLinejoin="round" vectorEffect="non-scaling-stroke"
    />
    <polygon
      points="28.50,6.06 71.50,6.06 96.50,43.30 71.50,80.54 28.50,80.54 3.50,43.30"
      fill="url(#hphoto-face)" stroke="rgba(0,0,0,0.18)" strokeWidth="0.4"
      strokeLinejoin="round" vectorEffect="non-scaling-stroke"
    />
  </svg>
);
