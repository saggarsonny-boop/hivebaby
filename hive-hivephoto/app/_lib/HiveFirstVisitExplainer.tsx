...
// `localStorage` key `hive_welcomed_hivephoto` flipping). Shows once per
// device. Matches the canonical first-visit-explainer pattern in HiveOps H12.

import { useEffect, useState } from "react";
import { useStrings } from "./strings";

const STORAGE_KEY = "hive_welcomed_hivephoto";
const PAPER = "#f5f1e6";
const MUTED = "#9a9588";
