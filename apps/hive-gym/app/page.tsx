    ...
    <div style={{ maxWidth: '800px', margin: '4rem auto' }}>
      <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
        <h1 style={{ fontSize: '3.5rem', marginBottom: '1.5rem', lineHeight: 1.1 }}>
          ...
          <span style={{ color: 'var(--hive-gold)' }}>Gym Analysis</span>
        </h1>
        <p style={{ fontSize: '1.25rem', color: '#94a3b8', maxWidth: '600px', margin: '0 auto 3rem auto', lineHeight: 1.6 }}>
          A Sovereign-Lite tactical engine specifically engineered to parse, analyze, and extract strategic leverage from gym documentation.
        </p>
