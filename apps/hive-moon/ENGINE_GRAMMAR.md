...
domain_aliases:
  - plainscan.hive.baby
  - scan.hive.baby
repo: saggarsonny-boop/hivebaby:apps/hive-moon
...
vercel_project: hive-moon
vercel_root_directory: apps/hive-moon
...
- Vercel project: `hive-moon` (root `apps/hive-moon`). Auto-deploy on push to `main`.
