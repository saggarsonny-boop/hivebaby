  ...
  return (
    <main className="shell">
      <header className="hero">
        <p className="eyebrow">HiveMoon</p>
        <h1>Your Moon analysis, in plain English.</h1>
        <p className="lede">
      ...
      {result && (
        <>
          ...
          <div className="mt-8 mb-4 font-bold text-lg">Astrological Findings</div><FindingsTable findings={result.findings} />
          <div className="mt-8 mb-4 font-bold text-lg">Suggested Rituals / Alignments</div><DoctorQuestions questions={result.questionsForDoctor} />
          <div className="mt-8 mb-4 font-bold text-lg">Shadow Work & Warnings</div><RedFlagBox redFlags={result.redFlags} />
