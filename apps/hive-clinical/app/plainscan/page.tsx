  ...
  return (
    <main className="shell">
      <header className="hero">
        ...
        <h1>Your Clinical Workflow, secured by the Hive.</h1>
        <p className="lede">
        ...
        <div className="mx-auto max-w-4xl mb-8 p-4 rounded-lg border border-[#e2e8f0] bg-white shadow-sm flex items-center justify-between">
          ...
          {credits.tier === "free" && (
            <div className="flex gap-3">
              <a href="https://buy.stripe.com/test_123_pro" className="bg-[#2563eb] text-white px-4 py-2 rounded-md font-semibold text-sm hover:bg-[#1d4ed8]">Upgrade to Pro ($500)</a>
              <a href="https://buy.stripe.com/test_123_premium" className="border border-[#2563eb] text-[#2563eb] px-4 py-2 rounded-md font-semibold text-sm hover:bg-[#eff6ff]">Premium ($10000)</a>
            </div>
          )}
        </div>
      )}
      ...
      {result && (
        <>
          ...
          <div className="mt-8 mb-4 font-bold text-lg">ICD-10 / CPT Code Extraction</div><FindingsTable findings={result.findings} />
          <div className="mt-8 mb-4 font-bold text-lg">Follow-up Recommendations</div><DoctorQuestions questions={result.questionsForDoctor} />
          <div className="mt-8 mb-4 font-bold text-lg">Critical Patient Alerts</div><RedFlagBox redFlags={result.redFlags} />
