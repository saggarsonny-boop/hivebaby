// Lightweight in-process cost cap. HiveActivityPartner is stateless (no DB), so
// we can't keep a persistent ledger like hive-activity-partner does. Instead we count
