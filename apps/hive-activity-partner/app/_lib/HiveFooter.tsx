// Standard Hive footer with the canonical link set + "Made with ♥ in the
// Hive" signature. Mirrors apps/parkback/app/_lib/HiveFooter.tsx — kept
// per-engine for now while the package extraction settles.
