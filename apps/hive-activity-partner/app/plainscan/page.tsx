  ...
  return (
    <main className="shell">
      <header className="hero">
        <p className="eyebrow">HiveActivityPartner</p>
        <h1>Your ActivityPartner analysis, in plain English.</h1>
        <p className="lede">
      ...
      {result && (
        <>
          ...
          <div className="mt-8 mb-4 font-bold text-lg">Logistical Requirements & Gear</div><FindingsTable findings={result.findings} />
          <div className="mt-8 mb-4 font-bold text-lg">Immediate Action Items</div><DoctorQuestions questions={result.questionsForDoctor} />
          <div className="mt-8 mb-4 font-bold text-lg">Safety & Scheduling Risks</div><RedFlagBox redFlags={result.redFlags} />
