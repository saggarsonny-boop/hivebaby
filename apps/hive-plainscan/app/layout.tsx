...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
      <html lang="en">
        ...
        <CrossPollinationModal sourceEngine="hive-plainscan" targetEngine="UD Converter" targetUrl="https://converter.universaldocument.org" description="Need to convert or unlock complex documents? Try the UD Converter." />
        <FloatingCompanion engineName="hive-plainscan" />
      </body>
      </html>
  );
}