...
export const metadata: Metadata = {
  title: "UD Redactor | Sovereign Analysis",
  ...
  return (
    <ClerkProvider>
      <html lang="en">
        <body>
          <div className="container">
            <header className="navbar">
              <a href="/" className="logo">UD Redactor</a>
              <div>
        ...
        <CrossPollinationModal sourceEngine="ud-redactor" targetEngine="UD Converter" targetUrl="https://converter.universaldocument.org" description="Need to convert or unlock complex documents? Try the UD Converter." />
      </body>
      </html>
    </ClerkProvider>
  );
