  ...
  return (
    <main className="shell">
      <header className="hero">
        <p className="eyebrow">HiveSecretbox</p>
        <h1>Your Secretbox analysis, in plain English.</h1>
        <p className="lede">
      ...
      {result && (
        <>
          ...
          <div className="mt-8 mb-4 font-bold text-lg">Psychological Themes & Motifs</div><FindingsTable findings={result.findings} />
          <div className="mt-8 mb-4 font-bold text-lg">Reflective Journaling Prompts</div><DoctorQuestions questions={result.questionsForDoctor} />
          <div className="mt-8 mb-4 font-bold text-lg">Cognitive Distortions / Warnings</div><RedFlagBox redFlags={result.redFlags} />
