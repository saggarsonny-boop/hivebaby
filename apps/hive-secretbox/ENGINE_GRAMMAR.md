...
domain_aliases:
  - plainscan.hive.baby
  - scan.hive.baby
repo: saggarsonny-boop/hivebaby:apps/hive-secretbox
...
vercel_project: hive-secretbox
vercel_root_directory: apps/hive-secretbox
...
- Vercel project: `hive-secretbox` (root `apps/hive-secretbox`). Auto-deploy on push to `main`.
