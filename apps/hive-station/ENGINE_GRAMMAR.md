...
domain_aliases:
  - plainscan.hive.baby
  - scan.hive.baby
repo: saggarsonny-boop/hivebaby:apps/hive-station
...
vercel_project: hive-station
vercel_root_directory: apps/hive-station
...
- Vercel project: `hive-station` (root `apps/hive-station`). Auto-deploy on push to `main`.
