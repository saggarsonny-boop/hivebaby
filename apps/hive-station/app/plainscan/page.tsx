  ...
  return (
    <main className="shell">
      <header className="hero">
        <p className="eyebrow">HiveStation</p>
        <h1>Your Station analysis, in plain English.</h1>
        <p className="lede">
      ...
      {result && (
        <>
          ...
          <div className="mt-8 mb-4 font-bold text-lg">Equipment & Layout Findings</div><FindingsTable findings={result.findings} />
          <div className="mt-8 mb-4 font-bold text-lg">Workspace Improvement Steps</div><DoctorQuestions questions={result.questionsForDoctor} />
          <div className="mt-8 mb-4 font-bold text-lg">Posture & Ergonomic Health Risks</div><RedFlagBox redFlags={result.redFlags} />
