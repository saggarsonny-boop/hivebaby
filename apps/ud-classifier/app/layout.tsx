...
export const metadata: Metadata = {
  title: "UD Classifier | Sovereign Analysis",
  ...
  return (
    <ClerkProvider>
      <html lang="en">
        <body>
          <div className="container">
            <header className="navbar">
              <a href="/" className="logo">UD Classifier</a>
              <div>
        ...
        <CrossPollinationModal sourceEngine="ud-classifier" targetEngine="UD Converter" targetUrl="https://converter.universaldocument.org" description="Need to convert or unlock complex documents? Try the UD Converter." />
      </body>
      </html>
    </ClerkProvider>
  );
