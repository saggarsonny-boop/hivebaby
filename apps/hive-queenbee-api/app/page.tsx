...
export default async function QueenBeeAPILanding() {
      ...
      <div className="z-10 text-center max-w-2xl">
        ...
        {userId ? (
          <div className="flex flex-col items-center gap-6 ud-fade-in">
            ...
            <Link href="/dashboard" className="ud-btn-primary px-8 py-4 text-lg fabulous-hover rounded-full bg-gradient-to-r from-[#2563eb] to-[#1d4ed8] border-none shadow-[0_0_40px_rgba(37,99,235,0.3)]">
