  ...
  return (
    <main className="shell">
      <header className="hero">
        <p className="eyebrow">HivePhoto</p>
        <h1>Your Photo analysis, in plain English.</h1>
        <p className="lede">
      ...
      {result && (
        <>
          ...
          <div className="mt-8 mb-4 font-bold text-lg">Artistic & Technical Elements</div><FindingsTable findings={result.findings} />
          <div className="mt-8 mb-4 font-bold text-lg">Post-Processing & Editing Suggestions</div><DoctorQuestions questions={result.questionsForDoctor} />
          <div className="mt-8 mb-4 font-bold text-lg">Exposure & Composition Flaws</div><RedFlagBox redFlags={result.redFlags} />
