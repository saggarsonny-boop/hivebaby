  ...
  return (
    <main className="min-h-screen bg-white text-[#243b53] flex flex-col items-center justify-center p-6 font-sans">
      <div className="z-10 text-center max-w-4xl w-full">
        ...
        <p className="text-xl text-[#64748b] mb-12 font-light tracking-wide">
          Enterprise Legal Risk & IP Analysis Engine.
        </p>
    ...
    <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm flex flex-col">
      ...
      <ul className="text-sm text-gray-600 mb-6 flex-grow space-y-2">
        <li className="flex gap-2"><span className="text-[#0a7a6a] font-bold">✓</span> <span>1 contract scan/mo</span></li><li className="flex gap-2"><span className="text-[#0a7a6a] font-bold">✓</span> <span>Max 10 pages</span></li><li className="flex gap-2"><span className="text-[#0a7a6a] font-bold">✓</span> <span>Standard Liability check</span></li><li className="flex gap-2"><span className="text-[#0a7a6a] font-bold">✓</span> <span>Cancel anytime</span></li>
      </ul>
    ...
    <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm flex flex-col">
      ...
      <ul className="text-sm text-gray-600 mb-6 flex-grow space-y-2">
        <li className="flex gap-2"><span className="text-[#0a7a6a] font-bold">✓</span> <span>50 scans/mo</span></li><li className="flex gap-2"><span className="text-[#0a7a6a] font-bold">✓</span> <span>Export to Risk PDF</span></li><li className="flex gap-2"><span className="text-[#0a7a6a] font-bold">✓</span> <span>IP Risk highlighting</span></li><li className="flex gap-2"><span className="text-[#0a7a6a] font-bold">✓</span> <span>Cancel anytime</span></li>
      </ul>
    ...
    <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm flex flex-col">
      ...
      <p className="text-3xl font-black text-[#D4AF37] mb-4">$499<span className="text-sm font-normal text-gray-500">/mo</span></p>
      <ul className="text-sm text-gray-600 mb-6 flex-grow space-y-2">
        <li className="flex gap-2"><span className="text-[#0a7a6a] font-bold">✓</span> <span>Unlimited scans</span></li><li className="flex gap-2"><span className="text-[#0a7a6a] font-bold">✓</span> <span>Custom Company Rules</span></li><li className="flex gap-2"><span className="text-[#0a7a6a] font-bold">✓</span> <span>Team Seats</span></li><li className="flex gap-2"><span className="text-[#0a7a6a] font-bold">✓</span> <span>Cancel anytime</span></li>
      </ul>
