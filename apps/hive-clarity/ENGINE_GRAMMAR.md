...
domain_aliases:
  - plainscan.hive.baby
  - scan.hive.baby
repo: saggarsonny-boop/hivebaby:apps/hive-clarity
...
vercel_project: hive-clarity
vercel_root_directory: apps/hive-clarity
...
- Vercel project: `hive-clarity` (root `apps/hive-clarity`). Auto-deploy on push to `main`.
