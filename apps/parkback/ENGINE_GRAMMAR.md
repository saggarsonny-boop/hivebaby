...
domain_aliases:
  - plainscan.hive.baby
  - scan.hive.baby
repo: saggarsonny-boop/hivebaby:apps/hive-parkback
...
vercel_project: hive-parkback
vercel_root_directory: apps/hive-parkback
...
- Vercel project: `hive-parkback` (root `apps/hive-parkback`). Auto-deploy on push to `main`.
