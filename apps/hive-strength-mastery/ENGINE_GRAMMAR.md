...
domain_aliases:
  - plainscan.hive.baby
  - scan.hive.baby
repo: saggarsonny-boop/hivebaby:apps/hive-strength-mastery
...
vercel_project: hive-strength-mastery
vercel_root_directory: apps/hive-strength-mastery
...
- Vercel project: `hive-strength-mastery` (root `apps/hive-strength-mastery`). Auto-deploy on push to `main`.
