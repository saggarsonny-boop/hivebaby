// Lightweight in-process cost cap. HiveStrengthMastery is stateless (no DB), so
// we can't keep a persistent ledger like hive-strength-mastery does. Instead we count
