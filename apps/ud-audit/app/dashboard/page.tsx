      ...
      <div style={{ maxWidth: '600px', margin: '6rem auto', textAlign: 'center' }}>
        <div className="glass-card">
          ...
          <p style={{ color: '#94a3b8', marginBottom: '2.5rem', lineHeight: 1.6 }}>
            The Audit AI Analysis Engine is restricted to Enterprise subscribers. Activate your license to unlock sovereign legal inference.
          </p>
  ...
  return (
    <div style={{ maxWidth: '900px', margin: '2rem auto' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '3rem' }}>
        <div>
          <h1 style={{ fontSize: '2rem', margin: 0, fontWeight: 700, letterSpacing: '-0.02em' }}>Audit Analysis HUD</h1>
