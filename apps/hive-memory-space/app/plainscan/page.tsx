  ...
  return (
    <main className="shell">
      <header className="hero">
        <p className="eyebrow">HiveMemorySpace</p>
        <h1>Your MemorySpace analysis, in plain English.</h1>
        <p className="lede">
      ...
      {result && (
        <>
          ...
          <div className="mt-8 mb-4 font-bold text-lg">Key Entities (People/Places/Objects)</div><FindingsTable findings={result.findings} />
          <div className="mt-8 mb-4 font-bold text-lg">Digital Preservation Steps</div><DoctorQuestions questions={result.questionsForDoctor} />
          <div className="mt-8 mb-4 font-bold text-lg">Emotional Triggers / Degradation Risks</div><RedFlagBox redFlags={result.redFlags} />
