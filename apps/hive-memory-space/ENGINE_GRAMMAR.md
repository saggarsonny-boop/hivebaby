...
domain_aliases:
  - plainscan.hive.baby
  - scan.hive.baby
repo: saggarsonny-boop/hivebaby:apps/hive-memory-space
...
vercel_project: hive-memory-space
vercel_root_directory: apps/hive-memory-space
...
- Vercel project: `hive-memory-space` (root `apps/hive-memory-space`). Auto-deploy on push to `main`.
