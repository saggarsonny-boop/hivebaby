...
domain_aliases:
  - plainscan.hive.baby
  - scan.hive.baby
repo: saggarsonny-boop/hivebaby:apps/hive-hivememe
...
vercel_project: hive-hivememe
vercel_root_directory: apps/hive-hivememe
...
- Vercel project: `hive-hivememe` (root `apps/hive-hivememe`). Auto-deploy on push to `main`.
