  ...
  return (
    <main className="shell">
      <header className="hero">
        <p className="eyebrow">HiveHivememe</p>
        <h1>Your Hivememe analysis, in plain English.</h1>
        <p className="lede">
      ...
      {result && (
        <>
          ...
          <div className="mt-8 mb-4 font-bold text-lg">Viral Psychological Elements</div><FindingsTable findings={result.findings} />
          <div className="mt-8 mb-4 font-bold text-lg">Copy & Caption Ideas</div><DoctorQuestions questions={result.questionsForDoctor} />
          <div className="mt-8 mb-4 font-bold text-lg">Brand Risks & "Cancel" Potential</div><RedFlagBox redFlags={result.redFlags} />
