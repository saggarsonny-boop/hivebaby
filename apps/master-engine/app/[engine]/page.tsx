...
export default function Home({ params }: { params: { engine: string } }) {
  ...
  const domainKey = params.engine.replace("ud-", "");
    ...
    <div style={{ maxWidth: '900px', margin: '4rem auto', position: 'relative' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '5rem' }}>
        <h1 className="hero-title">
          ...
          <span style={{ color: 'var(--hive-gold)', WebkitTextFillColor: 'initial' }}>{domainKeyUpper} Analysis</span>
        </h1>
        <p className="hero-subtitle">
          A Sovereign-Lite tactical engine specifically engineered to parse domain-specific files, extract logic flaws, and flag immediate liabilities in seconds.
        </p>
      ...
      <div className="glass-card">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem' }}>
          <div>
            ...
            <p style={{ color: '#94a3b8', lineHeight: 1.6, fontSize: '0.9rem' }}>Upload complex files. Our engine maps clauses against a sovereign index to flag contradictions instantly.</p>
          </div>
          <div>
