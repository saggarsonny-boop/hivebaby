    ...
    return (
      <div style={{ maxWidth: '600px', margin: '6rem auto', textAlign: 'center' }}>
        <div className="glass-card" style={{ position: 'relative', overflow: 'hidden' }}>
          {/* Decorative Glow */}
          <div style={{ position: 'absolute', top: '-50px', left: '50%', transform: 'translateX(-50%)', width: '200px', height: '200px', background: 'var(--hive-gold)', filter: 'blur(100px)', opacity: 0.1, zIndex: -1 }}></div>

          <div style={{ margin: '0 auto 1.5rem auto', display: 'flex', justifyContent: 'center' }}>
            <Image src="/ud-logo-micro.png" alt="UD Logo" width={64} height={64} style={{ filter: 'drop-shadow(0 0 10px rgba(212,175,55,0.3))' }} />
          </div>
          ...
          <div style={{ padding: '2rem', background: 'rgba(0,0,0,0.4)', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.05)', marginBottom: '2.5rem' }}>
            <div style={{ fontSize: '3rem', fontWeight: 700, color: 'var(--hive-gold)' }}>$699 <span style={{ fontSize: '1rem', color: '#64748b', fontWeight: 400 }}>/ month</span></div>
          </div>
    ...
    <div style={{ maxWidth: '900px', margin: '2rem auto' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '3rem' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          <Image src="/ud-logo-micro.png" alt="UD Logo" width={48} height={48} />
          <div>
      ...
      >
        <div style={{ margin: '0 auto 1.5rem auto', opacity: 0.9, background: 'rgba(212, 175, 55, 0.1)', width: '64px', height: '64px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="var(--hive-gold)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="12" y1="18" x2="12" y2="12"></line><line x1="9" y1="15" x2="15" y2="15"></line></svg>
        </div>
        <h3 style={{ fontSize: '1.25rem', marginBottom: '0.5rem', fontWeight: 600 }}>Secure Ingestion Dropzone</h3>
        <p style={{ color: '#94a3b8', fontSize: '0.9rem', marginBottom: '1rem', lineHeight: 1.5 }}>
          Drag and drop <strong style={{ color: 'var(--hive-gold)', fontWeight: 600 }}>UDS files</strong> here for immediate, native ingestion.<br/>
