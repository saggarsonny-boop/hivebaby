...
export const metadata: Metadata = {
  title: "UD Mp3 Transcript | Sovereign Analysis",
  ...
  return (
    <ClerkProvider>
      <html lang="en">
        <body>
          <div className="container">
            <header className="navbar">
              <a href="/" className="logo">UD Mp3 Transcript</a>
              <div>
        ...
        <CrossPollinationModal sourceEngine="ud-mp3-transcript" targetEngine="UD Converter" targetUrl="https://converter.universaldocument.org" description="Need to convert or unlock complex documents? Try the UD Converter." />
      </body>
      </html>
    </ClerkProvider>
  );
