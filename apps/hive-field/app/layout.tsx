...
export const metadata: Metadata = {
  title: "Hive Field | Sovereign Analysis",
  ...
  return (
    <>
      <html lang="en">
        <body>
          <div className="container">
            <header className="navbar">
              <a href="/" className="logo">Hive Field</a>
              <div>
        ...
        <CrossPollinationModal sourceEngine="hive-field" targetEngine="UD Converter" targetUrl="https://converter.universaldocument.org" description="Need to convert or unlock complex documents? Try the UD Converter." />
      </body>
      </html>
    </>
  );
