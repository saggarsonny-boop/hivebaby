...
export const metadata: Metadata = {
  title: "UD Converter | Sovereign Analysis",
  ...
  return (
    <ClerkProvider>
      <html lang="en">
        <body>
          <div className="container">
            <header className="navbar">
              <a href="/" className="logo">UD Converter</a>
              <div>
        ...
        <CrossPollinationModal sourceEngine="ud-converter" targetEngine="Hive PlainScan" targetUrl="https://plainscan.hive.baby" description="Have a medical report? Get it explained in plain English." />
      </body>
      </html>
    </ClerkProvider>
  );
