...
export const metadata: Metadata = {
  title: "Hive Demography Os | Sovereign Analysis",
  ...
  return (
    <ClerkProvider>
      <html lang="en">
        <body>
          <div className="container">
            <header className="navbar">
              <a href="/" className="logo">Hive Demography Os</a>
              <div>
        ...
        <CrossPollinationModal sourceEngine="hive-demography-os" targetEngine="UD Converter" targetUrl="https://converter.universaldocument.org" description="Need to convert or unlock complex documents? Try the UD Converter." />
      </body>
      </html>
    </ClerkProvider>
  );
