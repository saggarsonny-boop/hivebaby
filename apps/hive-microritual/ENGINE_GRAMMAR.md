...
domain_aliases:
  - plainscan.hive.baby
  - scan.hive.baby
repo: saggarsonny-boop/hivebaby:apps/hive-microritual
...
vercel_project: hive-microritual
vercel_root_directory: apps/hive-microritual
...
- Vercel project: `hive-microritual` (root `apps/hive-microritual`). Auto-deploy on push to `main`.
