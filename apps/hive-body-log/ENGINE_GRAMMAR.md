...
domain_aliases:
  - plainscan.hive.baby
  - scan.hive.baby
repo: saggarsonny-boop/hivebaby:apps/hive-body-log
...
vercel_project: hive-body-log
vercel_root_directory: apps/hive-body-log
...
- Vercel project: `hive-body-log` (root `apps/hive-body-log`). Auto-deploy on push to `main`.
