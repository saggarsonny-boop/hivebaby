  ...
  return (
    <main className="shell">
      <header className="hero">
        <p className="eyebrow">HiveBodyLog</p>
        <h1>Your BodyLog analysis, in plain English.</h1>
        <p className="lede">
      ...
      {result && (
        <>
          ...
          <div className="mt-8 mb-4 font-bold text-lg">Tracked Symptoms & Markers</div><FindingsTable findings={result.findings} />
          <div className="mt-8 mb-4 font-bold text-lg">Questions for your Doctor</div><DoctorQuestions questions={result.questionsForDoctor} />
          <div className="mt-8 mb-4 font-bold text-lg">Warning Signs (Seek Medical Advice)</div><RedFlagBox redFlags={result.redFlags} />
