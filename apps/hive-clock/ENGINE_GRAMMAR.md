...
domain_aliases:
  - plainscan.hive.baby
  - scan.hive.baby
repo: saggarsonny-boop/hivebaby:apps/hive-clock
...
vercel_project: hive-clock
vercel_root_directory: apps/hive-clock
...
- Vercel project: `hive-clock` (root `apps/hive-clock`). Auto-deploy on push to `main`.
