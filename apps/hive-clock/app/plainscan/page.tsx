  ...
  return (
    <main className="shell">
      <header className="hero">
        <p className="eyebrow">HiveClock</p>
        <h1>Your Clock analysis, in plain English.</h1>
        <p className="lede">
      ...
      {result && (
        <>
          ...
          <div className="mt-8 mb-4 font-bold text-lg">Productivity Blocks & Focus Periods</div><FindingsTable findings={result.findings} />
          <div className="mt-8 mb-4 font-bold text-lg">Optimization Strategies</div><DoctorQuestions questions={result.questionsForDoctor} />
          <div className="mt-8 mb-4 font-bold text-lg">Major Time Drains & Inefficiencies</div><RedFlagBox redFlags={result.redFlags} />
