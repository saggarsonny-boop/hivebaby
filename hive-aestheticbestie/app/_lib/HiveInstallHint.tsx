...
// localStorage key `hive_install_hint_dismissed_hiveaestheticbestie`.
//
// Mirrors the same component name / props shape used across the Hive
// engines so HiveOps H11 detects it via the canonical filename.

import { useEffect, useMemo, useState } from "react";
import { useStrings } from "./strings";

const STORAGE_KEY = "hive_install_hint_dismissed_hiveaestheticbestie";
const GOLD = "#D4AF37";
const PAPER = "#f5f1e6";
const INK = "#0a0a0a";
