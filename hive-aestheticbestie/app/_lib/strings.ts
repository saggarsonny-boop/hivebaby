...
// Localized strings catalog for HiveAestheticBestie.
...
// Translations land in a follow-up PR; today every locale ships English
// content so the loader has a stable shape on first paint.
